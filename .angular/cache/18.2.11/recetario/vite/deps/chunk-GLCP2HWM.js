...
import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-DQLMLRMV.js";
import {
  firebase
} from "./chunk-6V3QGZ5P.js";
import {
  FirebaseApp
} from "./chunk-5FICW2L7.js";
import {
  VERSION,
...
import {
  ...
  switchMapTo,
  timer
} from "./chunk-BRIXPWZ5.js";
import {
  __async
} from "./chunk-AKWYGKHY.js";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-UBBZ5CCK.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
@firebase/app-check/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GLCP2HWM.js.map
